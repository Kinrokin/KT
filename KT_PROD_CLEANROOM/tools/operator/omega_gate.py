...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    _write(root, str(args.lock_output), truth_lock)
    _write(root, str(args.authority_resolution_output), authority_resolution)
    _write(root, str(args.historical_firewall_output), historical_firewall)
