...
def _domain6_outputs(root: Path, head_sha: str) -> Dict[str, Dict[str, Any]]:
    ...
    outputs: Dict[str, Dict[str, Any]] = {
        ...
        "KT_PROD_CLEANROOM/governance/public_verifier_rules.json": _law_surface(
            schema_id="kt.governance.public_verifier_rules.v2",
            law_id="PUBLIC_VERIFIER_RULES_V2_20260313",
            domain_id="DOMAIN_6_EXTERNAL_LEGIBILITY",
            summary="Public verifier surfaces must separate evidence commits from truth subject commits so external readers cannot overread HEAD as the verified subject.",
            authorities=[
                TRUTH_POINTER_REF,
            ...
            rules=[
                "Public verifier manifests may reference authoritative pointers, state receipts, branch protection evidence, and cryptographic publication evidence only.",
                "Public verifier manifests must emit evidence_commit, truth_subject_commit, subject_verdict, evidence_contains_subject, and evidence_equals_subject.",
