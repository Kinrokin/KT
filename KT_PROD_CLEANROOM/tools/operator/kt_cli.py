...
V1 = V1Profile(
    ...
    law_bundle_hash="bca49a85b0358be4761270f1a2ba6b8be539097354d6becac8b3c69875636d4b",
    ...
    authoritative_reseal_receipt=("KT_PROD_CLEANROOM/AUDITS/LAW_BUNDLE_CHANGE_RECEIPT_FL3_20260425T183522Z.json"),
