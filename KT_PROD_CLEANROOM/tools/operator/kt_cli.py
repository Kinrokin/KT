...
V1 = V1Profile(
    ...
    law_bundle_hash="93395e5743c2175397b508554a5aebd16797eb0b3a19e1a50386af2e41ec317c",
    ...
    authoritative_reseal_receipt=("KT_PROD_CLEANROOM/AUDITS/LAW_BUNDLE_CHANGE_RECEIPT_FL3_20260916T225000Z.json"),
