...
AUTHORITY_BRANCH = "author/b04-r6-package-promotion-authorization-packet"
REPLAY_BRANCH_PREFIX = "replay/b04-r6-package-promotion-authorization-packet"
ALLOWED_BRANCHES = frozenset({AUTHORITY_BRANCH, "main"})

AUTHORITATIVE_LANE = "B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_PACKET"
...
OUTCOME_BOUND = "B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_PACKET_BOUND__PACKAGE_PROMOTION_AUTHORIZATION_VALIDATION_NEXT"
OUTCOME_DEFERRED = "B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_PACKET_DEFERRED__NAMED_PACKET_DEFECT_REMAINS"
OUTCOME_INVALID = "B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_PACKET_INVALID__FORENSIC_PACKAGE_PROMOTION_AUTHORIZATION_REVIEW_NEXT"
SELECTED_OUTCOME = OUTCOME_BOUND
NEXT_LAWFUL_MOVE = "VALIDATE_B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_PACKET"
...
VALIDATION_SUCCESS_NEXT_MOVE = "AUTHOR_B04_R6_PACKAGE_PROMOTION_EXECUTION_PACKET"
...
AUTHORITY_DRIFT_KEYS = {
    "package_promotion_executed": "RC_B04R6_PACKAGE_PROMOTION_AUTH_PACKAGE_EXECUTION_DRIFT",
    "commercial_activation_claim_authorized": "RC_B04R6_PACKAGE_PROMOTION_AUTH_COMMERCIAL_CLAIM_DRIFT",
    "lobe_escalation_authorized": "RC_B04R6_PACKAGE_PROMOTION_AUTH_LOBE_ESCALATION_DRIFT",
    "truth_engine_law_changed": "RC_B04R6_PACKAGE_PROMOTION_AUTH_TRUTH_ENGINE_MUTATION",
    "trust_zone_law_changed": "RC_B04R6_PACKAGE_PROMOTION_AUTH_TRUST_ZONE_MUTATION",
    "package_promotion_treated_as_commercial_activation": (
        "RC_B04R6_PACKAGE_PROMOTION_AUTH_COMMERCIAL_CLAIM_DRIFT"
    ),
}
...
REASON_CODES = tuple(
    dict.fromkeys(
        (
            "RC_B04R6_PACKAGE_PROMOTION_AUTH_REVIEW_VALIDATION_MISSING",
            "RC_B04R6_PACKAGE_PROMOTION_AUTH_REVIEW_OUTCOME_DRIFT",
            "RC_B04R6_PACKAGE_PROMOTION_AUTH_NEXT_MOVE_DRIFT",
            "RC_B04R6_PACKAGE_PROMOTION_AUTH_INPUT_BINDINGS_EMPTY",
            "RC_B04R6_PACKAGE_PROMOTION_AUTH_READINESS_INCOMPLETE",
            "RC_B04R6_PACKAGE_PROMOTION_AUTH_CLAIM_TOKEN_DRIFT",
            "RC_B04R6_PACKAGE_PROMOTION_AUTH_TRUST_ZONE_FAILED",
            "RC_B04R6_PACKAGE_PROMOTION_AUTH_BENCHMARK_PREP_DRIFT",
...
AUTHORIZATION_CONTRACT_ROLES = (
    "promotion_scope_contract",
    "allowed_package_surface_contract",
    "excluded_package_surface_contract",
    ...
    "clean_distributable_no_secret_receipt",
...
PREP_ONLY_ROLES = (
    ...
    "package_repair_or_rollback_prep_only_draft",
...
OUTPUTS = {
    "authorization_contract": "b04_r6_package_promotion_authorization_packet_contract.json",
    "authorization_receipt": "b04_r6_package_promotion_authorization_packet_receipt.json",
    "authorization_report": "b04_r6_package_promotion_authorization_packet_report.md",
    "promotion_scope_contract": "b04_r6_package_promotion_authorization_scope_contract.json",
    "allowed_package_surface_contract": "b04_r6_package_promotion_allowed_surface_contract.json",
    "excluded_package_surface_contract": "b04_r6_package_promotion_excluded_surface_contract.json",
    "release_truth_derivation_contract": "b04_r6_package_promotion_release_truth_derivation_contract.json",
    "operator_obligation_contract": "b04_r6_package_promotion_operator_obligation_contract.json",
    "rollback_obligation_contract": "b04_r6_package_promotion_rollback_obligation_contract.json",
    "external_audit_requirements": "b04_r6_package_promotion_external_audit_requirements.json",
    "public_verifier_requirements": "b04_r6_package_promotion_public_verifier_requirements.json",
    "deployment_profile_requirements": "b04_r6_package_promotion_deployment_profile_requirements.json",
    "support_incident_requirements": "b04_r6_package_promotion_support_incident_requirements.json",
    "data_governance_requirements": "b04_r6_package_promotion_data_governance_requirements.json",
    "commercial_claim_ceiling": "b04_r6_package_promotion_commercial_claim_ceiling.json",
    "clean_distributable_no_secret_receipt": (
        "b04_r6_package_promotion_clean_distributable_no_secret_receipt.json"
    ),
    "blocker_closure_matrix": "b04_r6_package_promotion_blocker_closure_matrix.json",
    "no_authority_drift_receipt": "b04_r6_package_promotion_authorization_no_authority_drift_receipt.json",
    "authorization_validation_plan": "b04_r6_package_promotion_authorization_validation_plan.json",
    "authorization_validation_reason_codes": "b04_r6_package_promotion_authorization_validation_reason_codes.json",
    "package_promotion_execution_packet_prep_only_draft": (
        "b04_r6_package_promotion_execution_packet_prep_only_draft.json"
    ),
    "package_promotion_execution_validation_plan_prep_only": (
        "b04_r6_package_promotion_execution_validation_plan_prep_only.json"
    ),
    "package_promotion_evidence_review_packet_prep_only_draft": (
        "b04_r6_package_promotion_evidence_review_packet_prep_only_draft.json"
    ),
    "package_repair_or_rollback_prep_only_draft": "b04_r6_package_repair_or_rollback_prep_only_draft.json",
    "commercial_activation_review_packet_prep_only_draft": (
    ...
    "long_horizon_agent_workload_suite_prep_only": (
        "kt_long_horizon_agent_workload_suite_prep_only.json"
    ),
...
def _ensure_branch_context(root: Path) -> str:
    ...
    if branch in ALLOWED_BRANCHES or branch.startswith(REPLAY_BRANCH_PREFIX):
        if branch == "main" and common.git_rev_parse(root, "HEAD") != common.git_rev_parse(root, "origin/main"):
            _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_NEXT_MOVE_DRIFT", "main replay requires HEAD to equal origin/main")
        return branch
    _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_NEXT_MOVE_DRIFT", f"branch {branch!r} is not allowed")


def _load(root: Path, raw: str, *, label: str) -> Dict[str, Any]:
    payload = common.load_json_required(root, raw, label=label)
    if not isinstance(payload, dict):
        _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_REVIEW_VALIDATION_MISSING", f"{label} must be a JSON object")
    return payload
...
def _read_text(root: Path, raw: str, *, label: str) -> str:
    try:
        ...
        _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_REVIEW_VALIDATION_MISSING", str(exc))
    ...
    for label, payload in payloads.items():
        for key, value in _walk_items(payload):
            ...
            if _is_claim_bearing_field(key) and isinstance(value, str) and _contains_positive_authority_token(value):
                _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_CLAIM_TOKEN_DRIFT", f"{label}.{key}={value!r}")
    for label, text in texts.items():
        ...
        for phrase in (
            ...
            if phrase in normalized:
                _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_CLAIM_TOKEN_DRIFT", f"{label} contains {phrase!r}")
...
def _validate_handoff(payloads: Dict[str, Dict[str, Any]]) -> None:
    ...
    if contract.get("selected_outcome") != EXPECTED_PREVIOUS_OUTCOME:
        _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_REVIEW_OUTCOME_DRIFT", "validation contract outcome drift")
    if receipt.get("selected_outcome") != EXPECTED_PREVIOUS_OUTCOME:
        _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_REVIEW_OUTCOME_DRIFT", "validation receipt outcome drift")
    if contract.get("next_lawful_move") != EXPECTED_PREVIOUS_NEXT_MOVE:
        _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_NEXT_MOVE_DRIFT", "validation contract next move drift")
    if next_move.get("next_lawful_move") != EXPECTED_PREVIOUS_NEXT_MOVE:
        _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_NEXT_MOVE_DRIFT", "next-lawful-move receipt drift")
    required_true = (
        "r6_open",
        "package_promotion_review_validated",
        "package_promotion_authorization_packet_next",
        "truth_engine_law_unchanged",
        "trust_zone_law_unchanged",
    )
    for key in required_true:
        if contract.get(key) is not True:
            _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_READINESS_INCOMPLETE", f"validation contract {key} is not true")
    required_false = (
    ...
    for key in required_false:
        if contract.get(key) is not False:
            _fail(AUTHORITY_DRIFT_KEYS.get(key, "RC_B04R6_PACKAGE_PROMOTION_AUTH_READINESS_INCOMPLETE"), key)
    if not contract.get("binding_hashes"):
        _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_INPUT_BINDINGS_EMPTY", "validation binding hashes are empty")
...
def _readiness_matrix() -> Dict[str, Any]:
    categories = {
        "validated_package_promotion_review": "PASS",
        "r6_opening_evidence_review": "PASS",
        "runtime_cutover_evidence": "PASS",
        "expanded_canary_evidence": "PASS",
        "external_verifier_readiness": "PASS",
        "claim_compiler_claim_ceiling": "PASS",
        "commercial_claim_boundary": "PASS",
        "deployment_profile_readiness": "PASS",
        "operator_runbook_readiness": "PASS",
        "rollback_evidence": "PASS",
        "incident_freeze_evidence": "PASS",
        "truth_trust_unchanged_receipts": "PASS",
        "clean_distributable_no_secret_surface": "PASS",
        "package_promotion_blocker_closure": "PASS_FOR_AUTHORIZATION_PACKET_ONLY",
    }
    return {
        ...
        "blocking_reasons": [
            "package_promotion_authorization_requires_independent_validation",
            "package_promotion_execution_requires_execution_packet_authoring_and_validation",
            "commercial_activation_requires_later_commercial_activation_review",
        ],
    }
...
def _base(
    *,
    ...
    return {
        ...
        "commercial_claim_ceiling_summary": "R6 is open; package promotion authorization packet is authored; promotion execution and commercial activation remain unauthorized.",
...
def _contract(base: Dict[str, Any], *, role: str, purpose: str, requirements: Sequence[str]) -> Dict[str, Any]:
    return _artifact(
        base,
        schema_id=f"kt.b04_r6.package_promotion_authorization.{role}.v1",
        artifact_id=f"B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_{role.upper()}",
        contract_role=role,
...
def _prep_only(base: Dict[str, Any], *, role: str, purpose: str, benchmark: bool = False) -> Dict[str, Any]:
    payload = _artifact(
        base,
        schema_id=f"kt.b04_r6.package_promotion_authorization.{role}.prep_only.v1",
        artifact_id=f"B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_{role.upper()}",
        authority="PREP_ONLY",
        status="PREP_ONLY",
        purpose=purpose,
...
def _benchmark_payload(base: Dict[str, Any], *, role: str) -> Dict[str, Any]:
    common_payload = _prep_only(base, role=role, purpose="Prepare provider/runtime benchmark campaign.", benchmark=True)
    common_payload.update(
        {
            ...
            "score_dimensions": [
                ...
                "latency",
                "cost",
                "tokens_per_successful_lane",
                "cost_per_validated_lane",
                "cost_per_merged_pr",
                "cost_per_review_repair",
                "cost_per_replay_success",
                "json_validity_rate",
                "receipt_completeness",
                "trace_completeness",
                "failure_recovery_rate",
                "operator_intervention_rate",
                "claim_drift_failure_rate",
                "audit_readiness",
            ],
        }
    )
...
def _outputs(base: Dict[str, Any]) -> Dict[str, Any]:
    payloads: Dict[str, Any] = {
        "authorization_contract": _artifact(
            base,
            schema_id="kt.b04_r6.package_promotion_authorization_packet.contract.v1",
            artifact_id="B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_PACKET_CONTRACT",
            authorization_packet_summary=(
                "Authorizes only the validation of package-promotion authorization conditions. "
                "It does not execute package promotion or authorize commercial activation claims."
            ),
        ),
        "authorization_receipt": _artifact(
            base,
            schema_id="kt.b04_r6.package_promotion_authorization_packet.receipt.v1",
            artifact_id="B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_PACKET_RECEIPT",
            verdict="PACKAGE_PROMOTION_AUTHORIZATION_PACKET_BOUND_VALIDATION_NEXT",
        ),
        "authorization_validation_plan": _artifact(
            base,
            schema_id="kt.b04_r6.package_promotion_authorization.validation_plan.v1",
            artifact_id="B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_VALIDATION_PLAN",
            required_validations=[
                "validated package promotion review is bound",
                "release truth derivation is complete",
                "claim ceiling remains bounded",
                "benchmark prep remains non-authoritative",
                "package promotion is not executed",
                "commercial activation claims remain unauthorized",
            ],
        ),
        "authorization_validation_reason_codes": _artifact(
            base,
            schema_id="kt.b04_r6.package_promotion_authorization.reason_codes.v1",
            artifact_id="B04_R6_PACKAGE_PROMOTION_AUTHORIZATION_VALIDATION_REASON_CODES",
        ...
        "campaign_board": _artifact(
            ...
            package_promotion_authorization="BOUND_VALIDATION_NEXT",
            package_promotion_execution="BLOCKED_UNTIL_EXECUTION_PACKET_VALIDATION",
        ...
        "pipeline_board": _artifact(
            ...
            r6="OPEN",
            package_promotion_review="VALIDATED",
            package_promotion_authorization="BOUND",
            package_promotion_authorization_validation="NEXT",
        ...
        "claim_ceiling_current_state": _artifact(
            ...
            allowed_claims=[
                "R6 is open.",
                "Package promotion review is validated.",
                "Package promotion authorization packet is bound and awaits validation.",
                "Package promotion is not executed.",
                "Commercial activation is not authorized.",
                "Truth/trust law is unchanged.",
            ],
            forbidden_claims=[
                "KT package is promoted.",
        ...
        "future_blocker_register": _artifact(
            ...
            blockers=[
                "package_promotion_authorization_requires_validation",
                "package_promotion_execution_requires_execution_packet_authoring_and_validation",
                "commercial_activation_requires_separate_review_and_validation",
    ...
    contract_specs = {
        "promotion_scope_contract": (
            "Define bounded package-promotion authorization scope.",
            ["R6 open state may be packaged only after validation", "commercial activation remains excluded"],
        ),
        "allowed_package_surface_contract": (
            "Define allowed package surface.",
            ["release truth bundle", "public verifier bundle", "operator runbook", "deployment profile"],
        ),
        "excluded_package_surface_contract": (
            "Define excluded package surface.",
            ["commercial activation", "unreviewed lobe escalation", "unvalidated benchmark claims"],
        ),
        "release_truth_derivation_contract": (
            "Require release truth to derive from receipts.",
            ["claim compiler boundary", "validation receipts", "replay artifacts"],
        ),
        "operator_obligation_contract": (
            "Define operator obligations.",
            ["support runbook", "incident response", "rollback acknowledgement"],
        ),
        "rollback_obligation_contract": (
            "Define rollback obligations.",
            ["rollback evidence", "quarantine path", "freeze path"],
        ),
        "external_audit_requirements": (
        ...
        "deployment_profile_requirements": (
            ...
            ["runtime boundaries", "operator ownership", "fallback controls"],
        ),
        "support_incident_requirements": (
            "Define support and incident requirements.",
            ["freeze conditions", "support routing", "customer-safe status language"],
        ),
        "data_governance_requirements": (
            "Define data governance requirements.",
            ["no secret surface", "data handling boundary", "distributable hygiene"],
        ),
        "commercial_claim_ceiling": (
            "Bind commercial claim ceiling.",
            ["package promotion is not commercial activation", "commercial activation requires later authority"],
        ),
        "clean_distributable_no_secret_receipt": (
            "Record clean distributable and no-secret check requirements.",
            ["secret scan required", "archive/lab residue excluded"],
        ),
        "blocker_closure_matrix": (
            "Map blockers closed for authorization packet only.",
            ["review validated", "authorization validation still pending", "execution still blocked"],
        ),
        "no_authority_drift_receipt": (
            "Record no-authority-drift state.",
            ["no package execution", "no commercial activation", "benchmark prep non-authoritative"],
        ),
    }
    ...
    prep_purposes = {
        "package_promotion_execution_packet_prep_only_draft": "Prepare future package-promotion execution packet.",
        "package_promotion_execution_validation_plan_prep_only": "Prepare future execution-packet validation plan.",
        "package_promotion_evidence_review_packet_prep_only_draft": "Prepare future promotion evidence review.",
        "package_repair_or_rollback_prep_only_draft": "Prepare repair, rollback, quarantine, or freeze path.",
        "commercial_activation_review_packet_prep_only_draft": "Prepare later commercial activation review packet.",
...
def _report_text(contract: Dict[str, Any]) -> str:
    return "\n".join(
        [
            "# B04 R6 Package Promotion Authorization Packet",
            "",
            f"Outcome: {contract['selected_outcome']}",
            f"Next lawful move: {contract['next_lawful_move']}",
            "",
            "This packet binds the validated package-promotion review and freezes the authorization law.",
            "It does not execute package promotion and does not authorize commercial activation claims.",
            "",
            BENCHMARK_GOVERNING_STATEMENT,
            "",
...
def run(*, reports_root: Optional[Path] = None) -> Dict[str, Any]:
    ...
    if common.git_status_porcelain(root).strip():
        raise RuntimeError("FAIL_CLOSED: dirty worktree before B04 R6 package-promotion authorization packet")
    ...
    if trust_zone_validation.get("status") != "PASS" or trust_zone_validation.get("failures"):
        _fail("RC_B04R6_PACKAGE_PROMOTION_AUTH_TRUST_ZONE_FAILED", "fresh trust-zone validation must pass")
    base = _base(
