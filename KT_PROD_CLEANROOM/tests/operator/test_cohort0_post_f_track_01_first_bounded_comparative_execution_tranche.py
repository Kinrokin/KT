...
from tools.operator import cohort0_post_f_track_01_first_bounded_comparative_execution_tranche as tranche
...
def test_post_f_track_01_first_bounded_comparative_execution_binds(tmp_path: Path, monkeypatch) -> None:
    ...
    _write_json(
        reports / contract_tranche.OUTPUT_PACKET,
        {
            ...
            "subject_head": "head-123",
            "next_lawful_move": "EXECUTE_POST_F_TRACK_01_FIRST_BOUNDED_COMPARATIVE_EXECUTION",
            "score_states": {
                "PASS": {"points": 2},
                "PARTIAL": {"points": 1},
                "FAIL": {"points": 0},
    ...
    assert verdict["verdict"] == "KT_CANONICAL_WEDGE_ADVANTAGE__CATEGORY_FAIR"
