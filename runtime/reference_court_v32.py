...
def adjudicate_reference_court_v32(
    ...
    *,
    ...
    """Independent offline STOP300 V2 court.

    This module intentionally imports no runtime FSM helpers. It reconstructs
    semantic boundaries from immutable raw text/token evidence.
    """
    ...
    if second_marker >= 0 and (newline is None or second_marker < newline.start()):
        ...
        lawful = bool(first_payload) and not correction
