# V17.7.4 ReProLock Generalization Probe One Cell

Packet: `packets/ktv1774_reprolock_generalization_probe_v1.zip`
...
os.environ["KT_RUN_MODE"] = "RUN_KTV1774_REPROLOCK_GENERALIZATION_PROBE_50"
...
packet = Path("/kaggle/input/ktv1774-reprolock-generalization-probe-v1/ktv1774_reprolock_generalization_probe_v1.zip")
